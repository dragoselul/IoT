...
FAKE_VOID_FUNC(calculate_average, int16_t, average_t);
FAKE_VALUE_FUNC(int16_t, get_average, average_t);
...
TEST_F(TempHumTest, get_humidity_float) 
{
	// Arrange
	get_humidity_float();
	// Assert/Expect
	ASSERT_EQ(1,hih8120_getHumidity_fake.call_count);
}

TEST_F(TempHumTest, get_temperature_float) 
{
	// Arrange
	get_temperature_float();
	// Assert/Expect
	ASSERT_EQ(1,hih8120_getTemperature_fake.call_count);
}

TEST_F(TempHumTest, get_humidity_int_no_args) 
{
	// Assert/Expect
	ASSERT_EQ(get_humidity_int(NULL), 0);
}

TEST_F(TempHumTest, get_humidity_int_args_without_measurement) 
{
	// Arrange
	tempAndHum_t tempAndHum = tempAndHum_create();
	// Assert/Expect
	ASSERT_EQ(0,get_humidity_int(tempAndHum));
}

TEST_F(TempHumTest, get_temperature_int_no_args) 
{
	// Assert/Expect
	ASSERT_EQ(get_temperature_int(NULL), 0);
}

TEST_F(TempHumTest, get_temperature_int_args_without_measurement) 
{
	// Arrange
	tempAndHum_t tempAndHum = tempAndHum_create();
	// Assert/Expect
	ASSERT_EQ(0,get_temperature_int(tempAndHum));
}
